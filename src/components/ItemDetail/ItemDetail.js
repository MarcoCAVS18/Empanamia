...
import ItemDetailsContainer from "../ItemDetailContainer/ItemDetailContainer";
...
const ItemDetail = ({ id, name, img, category, description, price, stock }) => {
  return (
    <article className="border-2 border-gray rounded-lg text-left pb-4 flex-col shadow-2xl">
      ...
      <ItemDetailsContainer id={id} name={name} img={img} category={category} description={description} price={price} stock={stock} />

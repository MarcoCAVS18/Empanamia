    ...
    <>
      ...
      {modalOpen && product && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          <div className="bg-white rounded-lg p-4 z-10 relative border border-solid border-gray-200 flex shadow-2xl">
            <button
            ...
            <div className="w-1/2 ml-4 flex flex-col justify-between">
              <div>
                <h2 className="text-xl mb-4 uppercase pt-4">{product.name}</h2>
